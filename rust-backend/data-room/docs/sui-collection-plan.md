...
Spec: `docs/data-room-spec.md`. Ops: `rust-backend/data-room/docs/runbook.md`.
...
Mirror the same edit into `rust-backend/data-room/deploy/collector.toml.example` in git
