...
Output (stdout): a JSON array of affected service names, sorted.
    ...
    ["api-service","keeper","mm-bot","price-charting","quoting-service"]
...
SERVICE_GLOBS: dict[str, list[str]] = {
    ...
    "staging-mm-bot": [
        "rust-backend/services/staging-mm-bot/**",
        "rust-backend/Dockerfile.staging-mm-bot",
    ],
    "api-service": [
    ...
    "vault-messenger": [
        "rust-backend/services/vault-messenger/**",
        "rust-backend/Dockerfile.vault-messenger",
    ],
    "gas-station": [
