//! Postgres persistence for the token-info catalog.
//!
//! Mirrors the indexer's db module: embedded migrations, an r2d2 pool, and a
//! single `Repo` over the one catalog table.
