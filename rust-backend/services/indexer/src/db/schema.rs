...
diesel::table! {
    trading_vaults (vault_id) {
        ...
        structure_code            -> Int2,
        senior_hurdle_bps_annual  -> Int8,
        target_junior_bps         -> Int8,
        maintenance_junior_bps    -> Int8,
        upside_code               -> Int2,
        residual_participation_bps -> Int8,
        total_return_cap_bps      -> Int8,
        terms_version             -> Int8,
        spec_hash                 -> Nullable<Text>,
        senior_shares             -> Numeric,
        junior_shares             -> Numeric,
        senior_claim              -> Numeric,
        senior_principal_basis    -> Numeric,
        senior_nav                -> Nullable<Numeric>,
        junior_nav                -> Nullable<Numeric>,
        latest_senior_pps_e12     -> Nullable<Numeric>,
        latest_junior_pps_e12     -> Nullable<Numeric>,
        risk_state                -> Int2,
        curator_commitment_breached -> Bool,
        impaired_since_ms         -> Nullable<Int8>,
        active_junior_generation  -> Int8,
        reset_old_generation      -> Nullable<Int8>,
        reset_proposed_at_ms      -> Nullable<Int8>,
        reset_executable_at_ms    -> Nullable<Int8>,
        reset_recorded_nav        -> Nullable<Numeric>,
        reset_recorded_senior_claim -> Nullable<Numeric>,
        reset_recorded_required_deposit -> Nullable<Int8>,
        settled                   -> Bool,
        settlement_final_nav      -> Nullable<Numeric>,
        senior_pool               -> Nullable<Int8>,
        senior_supply             -> Nullable<Numeric>,
        junior_pool               -> Nullable<Int8>,
        junior_supply             -> Nullable<Numeric>,
        settlement_snapshot_at_ms -> Nullable<Int8>,
        settlement_redeemed       -> Numeric,
        senior_lane_head          -> Int8,
        senior_lane_tail          -> Int8,
        junior_lane_head          -> Int8,
        junior_lane_tail          -> Int8,
    }
}

diesel::table! {
    vault_positions (position_id) {
        position_id        -> Text,
        vault_id           -> Text,
        tranche            -> Int2,
        capital_generation -> Int8,
        shares             -> Numeric,
        cost_basis         -> Numeric,
        locked_until_ms    -> Int8,
        // live | queued | consumed | settled | burned.
        status             -> Text,
        parent_position_id -> Nullable<Text>,
        merged_into        -> Nullable<Text>,
        queued_global_seq  -> Nullable<Int8>,
        created_at_ms      -> Int8,
        updated_at_ms      -> Int8,
        updated_at_seq     -> Int8,
    }
