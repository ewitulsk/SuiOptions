...
pub struct Claims {
    /// Subject: the admin Solana address (base58 ed25519 pubkey).
    pub sub: String,
...
mod tests {
    ...
    fn claims(exp: u64) -> Claims {
        Claims {
            sub: "4Nd1mBQtrMJVYVfKf2PJy9NZUZdTAsp7D4xWLs4gDB4T".into(),
            ip: "1.2.3.4".into(),
            iat: now_secs(),
            exp,
        }
    ...
    fn sign_then_verify() {
        ...
        assert_eq!(c.sub, "4Nd1mBQtrMJVYVfKf2PJy9NZUZdTAsp7D4xWLs4gDB4T");
