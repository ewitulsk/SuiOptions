...
module marketplace::listing {
    ...
    struct Listing has key {
        ...
        /// Fungible-asset metadata object the listing is priced in. A data
        /// field, not a type parameter, so one module serves APT, USDC, USDt.
        quote: address,
    ...
    #[view]
    /// Fungible-asset metadata object the listing is priced in.
    public fun quote(object: Object<Listing>): address acquires Listing {
        let listing = borrow_listing(object);
        listing.quote
    }
