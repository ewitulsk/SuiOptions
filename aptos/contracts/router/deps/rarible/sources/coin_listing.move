...
module coin_listing {
    ...
    use rarible::events;
    use rarible::fee_schedule::{Self, FeeSchedule};
    use rarible::listing::{Self, Listing};
    use aptos_framework::aptos_account;

    #[test_only]
    friend rarible::listing_tests;
...
module listing_tests {
    ...
    use rarible::test_utils::{mint_tokenv2_with_collection_royalty, mint_tokenv1_additional_royalty, mint_tokenv1};

    use rarible::coin_listing;
    use rarible::fee_schedule::FeeSchedule;
    use rarible::listing::{Self, Listing};
    use rarible::test_utils;
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x30002, location = rarible::listing)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x30005, location = rarible::coin_listing)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x10003, location = rarible::coin_listing)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x60001, location = rarible::coin_listing)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x10002, location = rarible::coin_listing)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x50006, location = rarible::coin_listing)]
