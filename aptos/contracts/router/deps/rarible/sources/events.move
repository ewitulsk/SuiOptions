...
module rarible::events {
    ...
    friend rarible::coin_listing;
    friend rarible::collection_offer;
    friend rarible::fee_schedule;
    friend rarible::listing;
    friend rarible::token_offer;
