...
module collection_offer {
    ...
    use rarible::listing::{Self, TokenV1Container};
...
module collection_offer_tests {
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x30006, location = rarible::collection_offer)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x60003, location = rarible::collection_offer)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x10005, location = rarible::collection_offer)]
