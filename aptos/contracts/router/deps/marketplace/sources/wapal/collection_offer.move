...
module collection_offer {
    ...
    use wapal::listing::{Self, TokenV1Container};
...
module collection_offer_tests {
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x30006, location = wapal::collection_offer)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x60003, location = wapal::collection_offer)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x10005, location = wapal::collection_offer)]
