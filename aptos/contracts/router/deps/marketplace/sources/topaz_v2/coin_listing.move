...
module coin_listing {
    ...
    use topaz_v2::events;
    use topaz_v2::fee_schedule::{Self, FeeSchedule};
    use topaz_v2::listing::{Self, Listing};
    use aptos_framework::aptos_account;

    #[test_only]
    friend topaz_v2::listing_tests;
...
module listing_tests {
    ...
    use topaz_v2::test_utils::{mint_tokenv2_with_collection_royalty, mint_tokenv1_additional_royalty, mint_tokenv1};

    use topaz_v2::coin_listing;
    use topaz_v2::fee_schedule::FeeSchedule;
    use topaz_v2::listing::{Self, Listing};
    use topaz_v2::test_utils;
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x30002, location = topaz_v2::listing)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x30005, location = topaz_v2::coin_listing)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x10003, location = topaz_v2::coin_listing)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x60001, location = topaz_v2::coin_listing)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x10002, location = topaz_v2::coin_listing)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x50006, location = topaz_v2::coin_listing)]
