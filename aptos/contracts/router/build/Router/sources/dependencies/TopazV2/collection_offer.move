...
module collection_offer {
    ...
    use topaz_v2::listing::{Self, TokenV1Container};
...
module collection_offer_tests {
    ...
    use topaz_v2::collection_offer;
    use topaz_v2::listing;
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x30006, location = topaz_v2::collection_offer)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x60003, location = topaz_v2::collection_offer)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x10005, location = topaz_v2::collection_offer)]
