...
module topaz_v2::events {
    ...
    friend topaz_v2::coin_listing;
    friend topaz_v2::collection_offer;
    friend topaz_v2::fee_schedule;
    friend topaz_v2::listing;
    friend topaz_v2::token_offer;
