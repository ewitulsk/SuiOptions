...
module coin_listing {
    ...
    use wapal::events;
    use wapal::fee_schedule::{Self, FeeSchedule};
    use wapal::listing::{Self, Listing};
    use aptos_framework::aptos_account;

    #[test_only]
    friend wapal::listing_tests;
...
module listing_tests {
    ...
    use wapal::test_utils::{mint_tokenv2_with_collection_royalty, mint_tokenv1_additional_royalty, mint_tokenv1};

    use wapal::coin_listing;
    use wapal::fee_schedule::FeeSchedule;
    use wapal::listing::{Self, Listing};
    use wapal::test_utils;
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x30002, location = wapal::listing)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x30005, location = wapal::coin_listing)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x10003, location = wapal::coin_listing)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x60001, location = wapal::coin_listing)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x10002, location = wapal::coin_listing)]
    ...
    #[test(aptos_framework = @0x1, marketplace = @0x111, seller = @0x222, purchaser = @0x333)]
    #[expected_failure(abort_code = 0x50006, location = wapal::coin_listing)]
