#[test_only]
module options_core::account_tests;
...
#[test]
#[expected_failure(abort_code = 15, location = options_core::account)] // not_owner
...
#[test]
#[expected_failure(abort_code = 11, location = options_core::account)] // insufficient_account_balance
...
#[test]
#[expected_failure(abort_code = 23, location = options_core::account)] // invalid_signing_scheme
...
#[test]
#[expected_failure(abort_code = 24, location = options_core::account)] // invalid_pubkey_length
...
#[test]
#[expected_failure(abort_code = 19, location = options_core::account)] // nonce_still_valid
