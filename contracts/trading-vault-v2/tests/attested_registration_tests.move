...
#[test_only]
module vault_v2::attested_registration_tests;

use std::type_name;
use sui::test_scenario::{Self as ts, Scenario};

use vault_v2::test_helpers::{Self as th, TestOracle, RogueOracle};
...
fun setup(pubkey: vector<u8>): Scenario {
    ...
    let vault_id = th::new_default_vault(&mut scenario, &clock);
...
#[test]
#[expected_failure(abort_code = 105, location = vault_v2::vault)] // external_already_set
...
#[test]
#[expected_failure(abort_code = 106, location = vault_v2::vault)] // attested_limits_exceeded
...
#[test]
#[expected_failure(abort_code = 107, location = vault_v2::vault)] // attestation_disabled
...
#[test]
#[expected_failure(abort_code = 108, location = vault_v2::vault)] // bad_attestation
...
#[test]
#[expected_failure(abort_code = 90, location = vault_v2::registry)] // config_invalid
