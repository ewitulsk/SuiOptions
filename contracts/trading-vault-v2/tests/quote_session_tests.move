...
///
/// v2: quote sessions abort 124 in any risk-off state, so every setup
/// that must get past the risk gate funds the curator commitment first.
module vault_v2::quote_session_tests;

use sui::balance;
use sui::test_scenario as ts;

use vault_v2::registry::{Self, IntegrationRegistry};
...
#[test]
#[expected_failure(abort_code = 75, location = vault_v2::vault)]
...
#[test]
#[expected_failure(abort_code = 72, location = vault_v2::vault)]
